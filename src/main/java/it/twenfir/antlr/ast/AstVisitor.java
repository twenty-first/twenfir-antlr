 ...
 * 
 * Provides an interface to compute aggregate values over AST's
 * Specific visitors should extends this interface and declare a visit() override method for each
 * node type in their AST's
 */
